// 1
const password = 'password', enter = prompt('Введите пароль');
password === enter ? alert('Пароль введен верно') : alert('Пароль введен неправильно');
// 2
...
// 8-9
const clientOS = Boolean(prompt('Ваша операционная система Android? Если да Введите в поле число 1, если нет нажмите отмена!'));
const clientAnswer = Boolean(prompt('Ваша модель телефона произведена ранее 2015 года? Если да Введите в поле число 1, если нет нажмите отмена!'));
